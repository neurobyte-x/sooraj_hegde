...
const stats = [
  { icon: <Code2 size={26} />, value: 400, suffix: "+", label: "DSA Problems", desc: "Solved across platforms", color: "#10b981" },
  ...
  { icon: <Target size={26} />, value: 8, suffix: "+", label: "Topic Mastery", desc: "Core DSA topics covered", color: "#ec4899" },
  { icon: <GitBranch size={26} />, value: 10, suffix: "+", label: "Repositories", desc: "Open source projects", color: "#e0e0e0" },
];
...
const profiles = [
  ...
  },
  {
    platform: "Codeforces",
    username: "sooraj_hegde",
    url: "https://codeforces.com/profile/sooraj_hegde",
    icon: (
      <svg viewBox="0 0 24 24" width="28" height="28" fill="currentColor">
  ...
  },
  {
    platform: "LeetCode",
    username: "sooraj_hegde",
    url: "https://leetcode.com/sooraj_hegde",
    icon: (
      <svg viewBox="0 0 24 24" width="28" height="28" fill="currentColor">
    ...
    rating: "1650+",
    ratingLabel: "Top 20%",
    description: "400+ problems solved with focus on medium & hard difficulty",
    badgeColor: "#f59e0b",
  },
  {
    platform: "GitHub",
